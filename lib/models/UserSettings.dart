...
class UserSettings extends amplify_core.Model {
  ...
  const UserSettings._internal({required this.id, createdAt, updatedAt}): _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory UserSettings({String? id}) {
  ...
  UserSettings copyWith({String? id}) {
    return UserSettings._internal(
      id: id ?? this.id);
  }
